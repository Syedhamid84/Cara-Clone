...
export const Newsletter = () => {
  return (
    <div className="flex justify-between gap-5 px-16 py-10 mt-12 bg-[#031d42] ">
      ...
      <div className="flex items-center rounded-md overflow-hidden text-xs md:text-sm lg:text-base">
        <input
          type="text"
